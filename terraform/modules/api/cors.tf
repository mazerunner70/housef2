...
resource "aws_api_gateway_method" "options_unassigned_imports" {
  rest_api_id   = aws_api_gateway_rest_api.main.id
...
resource "aws_api_gateway_method_response" "options_unassigned_imports" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.unassigned.id
  http_method = aws_api_gateway_method.options_unassigned_imports.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration" "options_unassigned_imports" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.unassigned.id
  http_method = aws_api_gateway_method.options_unassigned_imports.http_method
  type        = "MOCK"
...
resource "aws_api_gateway_integration_response" "options_unassigned_imports" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.unassigned.id
  http_method = aws_api_gateway_method.options_unassigned_imports.http_method
  status_code = aws_api_gateway_method_response.options_unassigned_imports.status_code
...
resource "aws_api_gateway_method" "options_paginated_imports" {
  rest_api_id   = aws_api_gateway_rest_api.main.id
...
resource "aws_api_gateway_method_response" "options_paginated_imports" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.paginated_imports.id
  http_method = aws_api_gateway_method.options_paginated_imports.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration" "options_paginated_imports" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.paginated_imports.id
  http_method = aws_api_gateway_method.options_paginated_imports.http_method
  type        = "MOCK"
...
resource "aws_api_gateway_integration_response" "options_paginated_imports" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.paginated_imports.id
  http_method = aws_api_gateway_method.options_paginated_imports.http_method
  status_code = aws_api_gateway_method_response.options_paginated_imports.status_code
